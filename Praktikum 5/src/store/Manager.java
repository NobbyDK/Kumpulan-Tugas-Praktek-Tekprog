...
public class Manager extends AbstractStoreEmployee {
    ...
    public double calculatePay() {
        ...
        if (salesDone > 25000.0) {
            bonusRate = 15.00;
        } else if (salesDone > 5000.0 && salesDone <= 25000.0) {
            bonusRate = 10.00;
        } else {
            bonusRate = 1;
        }
    ...
    public boolean checkPromotionEligibility() {
        ...
        if (calculatePay() > 50000.0 && calculatePay() < 60000.0) {
